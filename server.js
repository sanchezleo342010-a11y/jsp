...
<div class="container">
    <header style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px">
        <div style="display:flex;align-items:center">
            ...
            <h1 style="color:#ff007f;margin:0;font-size:26px;letter-spacing:2px;text-shadow:0 0 15px rgba(255,0,127,0.4)">SERENITY ADMIN</h1>
        </div>
        <button class="secondary" onclick="refreshDashboard();refreshLogs();" style="width:auto;padding:8px 18px">Refresh All</button>
    </header>
